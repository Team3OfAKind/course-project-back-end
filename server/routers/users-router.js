...
module.exports = ({ app, controllers, passport }) => {
    const controller = controllers.user;
        ...
        app.post('/api/users/addresses/add', passport.authenticate('jwt', { session: false }), controller.addAddress);
        app.post('/api/users/addresses/remove', passport.authenticate('jwt', { session: false }), controller.removeAddress);
